...
struct single_interp_value{
	robot_data_file_process::axispos pos;
	joint_velocity	vel;
	joint_acc acc;
public:
	single_interp_value(){}
	single_interp_value(robot_data_file_process::axispos p, joint_velocity	v, joint_acc a):pos(p), vel(v), acc(a){
